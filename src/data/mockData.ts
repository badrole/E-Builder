...
export const workers = [
  { id: 'w1', name: 'Dimas Hafif Maulana, S.T', category: 'Plumbing / Saluran Air', spec: 'Spesialis Pipa & Sanitasi', city: 'Surabaya', rating: 4.8, reviews: 124, jobs: 142, price: 150000, priceUnit: '/hari', status: 'idle' as const, verified: true, recommended: true, fastResponse: true, exp: '12 tahun', image: IMAGES.worker1, phone: '081913842272', whatsappNumber: '6281913842272', warranty: '30 hari garansi', bookedDates: ['2026-05-05', '2026-05-10'], pendingDates: ['2026-05-07'], portfolio: [IMAGES.bathroom, IMAGES.kitchen] },
  { id: 'w2', name: 'Jefran Andofian, S.T', category: 'Perbaikan Listrik', spec: 'Teknisi Listrik Bersertifikat', city: 'Jakarta', rating: 4.9, reviews: 89, jobs: 98, price: 200000, priceUnit: '/hari', status: 'idle' as const, verified: true, recommended: true, fastResponse: false, exp: '8 tahun', image: IMAGES.worker2, phone: '085932241861', whatsappNumber: '6285932241861', warranty: '14 hari garansi', bookedDates: ['2026-05-06'], pendingDates: [], portfolio: [IMAGES.electrical] },
  { id: 'w3', name: 'Ir. Noor Mahfud Idova, S.T', category: 'Renovasi Kamar Mandi', spec: 'Renovasi Full Kamar Mandi', city: 'Bandung', rating: 5.0, reviews: 56, jobs: 67, price: 1500000, priceUnit: '/proyek', status: 'idle' as const, verified: true, recommended: false, fastResponse: true, exp: '10 tahun', image: IMAGES.expert3, phone: '087824619869', whatsappNumber: '6287824619869', warranty: '60 hari garansi', bookedDates: ['2026-05-08', '2026-05-09'], pendingDates: ['2026-05-11'], portfolio: [IMAGES.bathReno] },
  { id: 'w4', name: 'Dimas Hafif Maulana, S.T', category: 'Pengecatan Rumah', spec: 'Cat Interior & Eksterior', city: 'Surabaya', rating: 4.7, reviews: 45, jobs: 78, price: 25000, priceUnit: '/m²', status: 'booked' as const, verified: true, recommended: true, fastResponse: false, exp: '15 tahun', image: IMAGES.worker1, phone: '081913842272', whatsappNumber: '6281913842272', warranty: '90 hari garansi', bookedDates: ['2026-05-04', '2026-05-05', '2026-05-06'], pendingDates: [], portfolio: [IMAGES.livingRoom, IMAGES.paint] },
  { id: 'w5', name: 'Thufail Abbad Bilfaj, S.T M.T', category: 'Perbaikan Atap', spec: 'Atap & Rangka Baja Ringan', city: 'Malang', rating: 4.6, reviews: 38, jobs: 55, price: 350000, priceUnit: '/hari', status: 'idle' as const, verified: false, recommended: false, fastResponse: true, exp: '7 tahun', image: IMAGES.expert1, phone: '085749780759', whatsappNumber: '6285749780759', warranty: '30 hari garansi', bookedDates: [], pendingDates: ['2026-05-12'], portfolio: [IMAGES.hero] },
  { id: 'w6', name: 'Jefran Andofian, S.T', category: 'Pemasangan Keramik', spec: 'Keramik & Granit Presisi', city: 'Jakarta', rating: 4.9, reviews: 67, jobs: 91, price: 45000, priceUnit: '/m²', status: 'idle' as const, verified: true, recommended: true, fastResponse: true, exp: '11 tahun', image: IMAGES.worker2, phone: '6285932241861', whatsappNumber: '6285932241861', warranty: '60 hari garansi', bookedDates: ['2026-05-15'], pendingDates: [], portfolio: [IMAGES.bathroom, IMAGES.kitchen] },
  { id: 'w7', name: 'Ir. Noor Mahfud Idova, S.T', category: 'Perbaikan Dinding', spec: 'Dinding & Plesteran', city: 'Bandung', rating: 4.5, reviews: 29, jobs: 43, price: 180000, priceUnit: '/hari', status: 'idle' as const, verified: true, recommended: false, fastResponse: false, exp: '9 tahun', image: IMAGES.expert3, phone: '087824619869', whatsappNumber: '6287824619869', warranty: '30 hari garansi', bookedDates: [], pendingDates: [], portfolio: [IMAGES.hero] },
  { id: 'w8', name: 'Dimas Hafif Maulana, S.T', category: 'Renovasi Dapur', spec: 'Dapur Modern & Minimalis', city: 'Surabaya', rating: 4.8, reviews: 52, jobs: 64, price: 2500000, priceUnit: '/proyek', status: 'pending' as const, verified: true, recommended: true, fastResponse: true, exp: '13 tahun', image: IMAGES.worker1, phone: '081913842272', whatsappNumber: '6281913842272', warranty: '60 hari garansi', bookedDates: ['2026-05-20'], pendingDates: ['2026-05-18'], portfolio: [IMAGES.kitchenReno, IMAGES.kitchen] },
];

export const experts = [
  { id: 'e1', name: 'Anastasya Putrika, S.Ars', spec: 'Arsitek', subSpec: 'Modern Minimalis', rating: 4.9, reviews: 124, exp: '15 tahun', fee: 250000, feeUnit: '/sesi', verified: true, badge: 'Premium Ahli', image: IMAGES.expert2, phone: '085828802085', whatsappNumber: '6285828802085', bio: 'Arsitek utama dengan spesialisasi desain modern minimalis dan sustainable architecture.', topics: ['Desain Rumah', 'Renovasi', 'Tata Ruang', 'IMB'], license: 'Lisensi IAI Aktif', schedule: ['Senin 09:00-17:00', 'Rabu 09:00-17:00', 'Jumat 09:00-12:00'] },
  { id: 'e2', name: 'Anastasya Putrika, S.Ars', spec: 'Interior Designer', subSpec: 'Luxury Residential', rating: 4.8, reviews: 89, exp: '8 tahun', fee: 200000, feeUnit: '/sesi', verified: true, badge: 'Rising Star', image: IMAGES.expert2, phone: '085828802085', whatsappNumber: '6285828802085', bio: 'Desainer interior dengan fokus pada hunian mewah dan ruang fungsional.', topics: ['Interior', 'Furniture', 'Lighting', 'Material'], license: 'Lisensi HDII Aktif', schedule: ['Selasa 10:00-16:00', 'Kamis 10:00-16:00'] },
  { id: 'e3', name: 'Ir. Noor Mahfud Idova, S.T', spec: 'Civil Engineer', subSpec: 'Struktur & High Rise', rating: 5.0, reviews: 210, exp: '20 tahun', fee: 300000, feeUnit: '/sesi', verified: true, badge: 'Ekspertis', image: IMAGES.expert3, phone: '087824619869', whatsappNumber: '6287824619869', bio: 'Ahli struktur berpengalaman dalam proyek high-rise dan infrastruktur.', topics: ['Struktur', 'Pondasi', 'Beton', 'Baja'], license: 'SKA Madya', schedule: ['Senin-Jumat 08:00-15:00'] },
  { id: 'e4', name: 'Thufail Abbad Bilfaj, S.T M.T', spec: 'Konsultan RAB', subSpec: 'Estimasi Biaya Konstruksi', rating: 4.7, reviews: 56, exp: '10 tahun', fee: 150000, feeUnit: '/sesi', verified: true, badge: 'Spesialis', image: IMAGES.expert1, phone: '085749780759', whatsappNumber: '6285749780759', bio: 'Konsultan RAB dengan keahlian estimasi biaya proyek konstruksi dan renovasi.', topics: ['RAB', 'Anggaran', 'Material', 'Tender'], license: 'Sertifikasi QS', schedule: ['Senin-Sabtu 09:00-17:00'] },
];

export const stores = [
  { id: 's1', name: 'Mitra Bangunan Jaya', city: 'Surabaya', rating: 4.8, reviews: 234, categories: ['Semen', 'Pasir & Bata', 'Baja Ringan'], delivery: true, open: true, image: IMAGES.concrete, address: 'Jl. Raya Darmo No. 45, Surabaya', whatsappNumber: '628111111111' },
  { id: 's2', name: 'Sumber Material Abadi', city: 'Jakarta', rating: 4.7, reviews: 189, categories: ['Cat', 'Keramik', 'Sanitary'], delivery: true, open: true, image: IMAGES.paint, address: 'Jl. Gatot Subroto No. 12, Jakarta Selatan', whatsappNumber: '628222222222' },
  { id: 's3', name: 'Toko Bangunan Sentosa', city: 'Malang', rating: 4.6, reviews: 145, categories: ['Listrik', 'Plumbing', 'Alat Bangunan'], delivery: true, open: false, image: IMAGES.pipes, address: 'Jl. Soekarno Hatta No. 78, Malang', whatsappNumber: '628333333333' },
  { id: 's4', name: 'Prima Keramik & Sanitary', city: 'Bandung', rating: 4.9, reviews: 312, categories: ['Keramik', 'Sanitary', 'Pintu & Jendela'], delivery: true, open: true, image: IMAGES.glass, address: 'Jl. Pasteur No. 33, Bandung', whatsappNumber: '628444444444' },
];
...
export const emergencyTechnicians = [
  { id: 'et1', name: 'Dimas Hafif Maulana, S.T', category: 'Listrik', city: 'Jakarta', arrival: '30 menit', rating: 4.9, fee: 250000, available: true, image: IMAGES.worker1, whatsappNumber: '628666666661' },
  { id: 'et2', name: 'Jefran Andofian, S.T', category: 'Plumbing', city: 'Surabaya', arrival: '45 menit', rating: 4.8, fee: 200000, available: true, image: IMAGES.worker2, whatsappNumber: '628666666662' },
  { id: 'et3', name: 'Thufail Abbad Bilfaj, S.T M.T', category: 'Atap', city: 'Bandung', arrival: '60 menit', rating: 4.7, fee: 300000, available: true, image: IMAGES.expert1, whatsappNumber: '628666666663' },
];
