  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-outline-variant p-6 space-y-4">
        ...
        <div className="p-4 bg-primary/5 rounded-xl text-center"><p className="text-sm text-outline">Total Pembayaran</p><p className="text-3xl font-black text-primary">{formatRupiah(latest.fee)}</p></div>
