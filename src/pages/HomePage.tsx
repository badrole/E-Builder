...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative px-4 md:px-6 lg:px-8 pt-8 sm:pt-12 pb-16 sm:pb-24 max-w-container mx-auto overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center">
          <div className="lg:col-span-6 z-10">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3">
              <Link to="/e-renov" className="btn-cta flex items-center justify-center gap-2 w-full sm:w-auto"><span className="material-symbols-outlined">explore</span>Cari Jasa</Link>
              <Link to="/rab" className="btn-outline flex items-center justify-center gap-2 w-full sm:w-auto"><span className="material-symbols-outlined">calculate</span>Hitung RAB</Link>
              <Link to="/consultation" className="btn-outline flex items-center justify-center gap-2 w-full sm:w-auto"><span className="material-symbols-outlined">support_agent</span>Konsultasi</Link>
            </div>
          </div>
      ...
      {/* Banner Carousel */}
      <section className="max-w-container mx-auto px-4 md:px-6 lg:px-8 -mt-8 relative z-20">
      ...
      {/* Feature Bubbles */}
      <section className="py-16 sm:py-24 max-w-container mx-auto px-4 md:px-6 lg:px-8">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex flex-wrap justify-between items-end gap-3 mb-8 sm:mb-12">
              ...
              <div key={w.id} className="group card-base overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <span className="text-primary font-bold price-text">Mulai {formatRupiah(w.price)}</span>
        ...
        <div className="bg-royal-blue rounded-[32px] p-8 sm:p-12 text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="glass-card rounded-2xl p-6 text-on-surface shadow-2xl">
              {trackingProjects[0] && (
                <>
                  <div className="flex flex-wrap justify-between items-center gap-2 mb-6"><h4 className="font-bold text-primary break-words">{trackingProjects[0].name}</h4><span className="px-3 py-1 bg-blue-100 text-primary text-xs font-bold rounded-full">PROGRES {trackingProjects[0].progress}%</span></div>
      ...
      {/* Materials */}
      <section className="py-16 max-w-container mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between items-end gap-3 mb-8 sm:mb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
          {products.slice(0, 5).map(p => (
            <Link key={p.id} to={`/materials/product/${p.id}`} className="group bg-white p-3 sm:p-4 rounded-2xl border border-outline-variant hover:shadow-lg transition-all">
              ...
              <p className="text-primary font-extrabold text-sm price-text">{formatRupiah(p.price)} <span className="text-xs text-on-surface-variant font-normal">/{p.unit}</span></p>
            </Link>
          ))}
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 glass-card p-8 sm:p-10 rounded-[32px] shadow-xl border border-outline-variant">
              ...
              <div className="p-6 bg-royal-blue/5 rounded-xl border border-royal-blue/10 mb-6">
                ...
                <p className="text-2xl md:text-4xl lg:text-5xl font-black text-primary price-text-strong">Rp21.600.000</p>
