...
export default function BecomePartnerPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 md:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="bg-gradient-to-r from-royal-blue to-secondary rounded-2xl p-4 md:p-6 text-white grid grid-cols-3 gap-4 text-center overflow-hidden"><div className="min-w-0"><p className="text-xl md:text-2xl font-black price-text">500+</p><p className="text-xs text-blue-100">Mitra Aktif</p></div><div className="min-w-0"><p className="text-xl md:text-2xl font-black price-text">Rp89jt</p><p className="text-xs text-blue-100">Rata-rata/bulan</p></div><div className="min-w-0"><p className="text-xl md:text-2xl font-black price-text">4.8★</p><p className="text-xs text-blue-100">Rating Platform</p></div></div>
